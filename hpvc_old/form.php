...
if(isset($_GET['err'])){
    if ($_GET['err']=="em") {
        echo '<script>
            alert("Your email id is not same, please enter same email id.");
        </script>';
    }
}
?>
    ...
    <div class="row">
        <form role="form" action="check.php" method="post">
            <div class="col-lg-6">
                ...
                <div class="form-group">
                    <label for="InputName">Enter Team Captain</label>
                    <div class="input-group">
                        <input type="text" class="form-control" name="capnm" id="InputName" placeholder="Enter Name" required>
                        <span class="input-group-addon" style="color:red;"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="email" class="form-control" id="InputEmailSecond" name="reemail" placeholder="Confirm Email" required>
                        <span class="input-group-addon" style="color:red;"><span class="glyphicon glyphicon-asterisk"></span></span>
                    </div>
                </div>
                <div class="form-group">
